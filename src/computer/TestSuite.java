...
public class TestSuite extends TopMenuTest {
    ...
    public void verifyProductsArrangeInAlphaBaticalOrder() throws InterruptedException {
        ...
        //Verify Z TO A filter is applied or no
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //2.16 Change the quantity to "2" and Click on "Update shopping cart"
        Thread.sleep(5000);
        ...
        //2.18 click on checkbox agree with the terms of service
        ...
        //2.22 Fill the all mandatory field
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"), "MOTSK");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_LastName']"), "OSYRK");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Email']"), "QWERTY@gmail.com");
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"), "ANAND");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Address1']"), "5, Jubilee Court");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']"), "387002");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"), "9909907777");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"), "AaaaBbbb");
        ...
        sendTextToElement(By.xpath("//input[@id='CardholderName']"), "Qwe Rty");
        sendTextToElement(By.xpath("//input[@id='CardNumber']"), "5425233430109903");
        sendTextToElement(By.xpath("//select[@id='ExpireMonth']"), "09");
        sendTextToElement(By.xpath("//select[@id='ExpireYear']"), "2024");
        sendTextToElement(By.xpath("//input[@id='CardCode']"), "175");
